...
class UsersHttpRequestTests {
    ...
    fun usersEndPointShouldReturnCollectionWithTwoUsers() {
        val response: Collection<*> =
            restTemplate.getForObject(BASE_URL + port + USERS_PATH, Collection::class.java)
    ...
    fun userEndPointDeleteUserShouldReturnVoid() {
        ...
        val users: Collection<*> =
            restTemplate.getForObject<Collection<*>>(BASE_URL + port + USERS_PATH, Collection::class.java)

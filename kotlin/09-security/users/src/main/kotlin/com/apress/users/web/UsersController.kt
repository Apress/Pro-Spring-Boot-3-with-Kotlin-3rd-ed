...
class UsersController {
    ...
    fun findUserById(@PathVariable email: String): ResponseEntity<User> =
        ResponseEntity.of(userRepository.findById(email))
    ...
    fun remove(@PathVariable email: String) =
    ...
    @Throws(Throwable::class)
    fun getUserGravatar(@PathVariable email: String): ResponseEntity<String> =
        ResponseEntity.ok(UserGravatar.getGravatarUrlFromEmail(email))
}
